                    ...
                    return (
                      <div
                        ...
                        className={`p-4 cursor-pointer transition-colors hover:bg-gray-50 ${
                          selectedChatRoom?.id === room.id ? 'bg-blue-50 border-l-4 border-primary-500' : ''
                        }`}
                      >
                          ...
                          >
                            ...
                            >
                              ...
                              <div className={`text-xs mt-2 ${
                                message.sender_type === 'user' ? 'text-gray-400' : 'text-primary-100'
                              }`}>
                  ...
                  <div className="p-4 bg-white border-t border-gray-200">
                    <div className="flex gap-3">
                      ...
                      <button
                        ...
                        className="bg-primary-500 hover:bg-primary-600 disabled:bg-gray-300 text-white px-6 py-3 rounded-lg transition-colors disabled:cursor-not-allowed flex items-center gap-2"
                      >
