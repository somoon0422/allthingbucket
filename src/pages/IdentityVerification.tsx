    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="text-center mb-12 animate-fade-in">
          <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-2xl shadow-lg shadow-blue-500/30 mb-6 transform hover:scale-110 transition-transform duration-300">
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-gray-100 p-8 mb-8">
          <div className="flex items-center justify-between max-w-2xl mx-auto">
            <div className={`flex flex-col items-center gap-2 flex-1 transition-all duration-300 ${step === 'identity' || step === 'account' || step === 'complete' ? 'text-blue-600' : 'text-gray-400'}`}>
              <div className={`w-12 h-12 rounded-full flex items-center justify-center font-semibold transition-all duration-300 ${step === 'identity' || step === 'account' || step === 'complete' ? 'bg-gradient-to-br from-blue-500 to-indigo-600 text-white shadow-lg shadow-blue-500/30 scale-110' : 'bg-gray-100'}`}>
                {step === 'account' || step === 'complete' ? <CheckCircle className="w-6 h-6" /> : '1'}
              </div>
              <span className="font-medium text-sm">본인인증</span>
            </div>
            <div className={`h-1 w-full flex-1 mx-4 rounded-full transition-all duration-500 ${step === 'account' || step === 'complete' ? 'bg-gradient-to-r from-blue-500 to-indigo-600' : 'bg-gray-200'}`}></div>
            <div className={`flex flex-col items-center gap-2 flex-1 transition-all duration-300 ${step === 'account' || step === 'complete' ? 'text-blue-600' : 'text-gray-400'}`}>
              <div className={`w-12 h-12 rounded-full flex items-center justify-center font-semibold transition-all duration-300 ${step === 'account' || step === 'complete' ? 'bg-gradient-to-br from-blue-500 to-indigo-600 text-white shadow-lg shadow-blue-500/30 scale-110' : 'bg-gray-100'}`}>
                {step === 'complete' ? <CheckCircle className="w-6 h-6" /> : '2'}
              </div>
              <span className="font-medium text-sm">계좌 등록</span>
            </div>
            <div className={`h-1 w-full flex-1 mx-4 rounded-full transition-all duration-500 ${step === 'complete' ? 'bg-gradient-to-r from-blue-500 to-indigo-600' : 'bg-gray-200'}`}></div>
            <div className={`flex flex-col items-center gap-2 flex-1 transition-all duration-300 ${step === 'complete' ? 'text-blue-600' : 'text-gray-400'}`}>
              <div className={`w-12 h-12 rounded-full flex items-center justify-center font-semibold transition-all duration-300 ${step === 'complete' ? 'bg-gradient-to-br from-blue-500 to-indigo-600 text-white shadow-lg shadow-blue-500/30 scale-110' : 'bg-gray-100'}`}>
        ...
        {step === 'identity' && (
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-100 p-10 transform transition-all duration-500 hover:shadow-2xl">
            <div className="text-center mb-8">
              <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-2xl shadow-lg shadow-blue-500/30 mx-auto mb-6">
                <Shield className="w-10 h-10 text-white" />
              </div>
            ...
            <button
              ...
              disabled={loading}
              className="w-full py-5 bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-lg rounded-xl font-semibold shadow-lg shadow-blue-500/30 hover:shadow-xl hover:shadow-blue-500/40 hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 transition-all duration-300"
            >
              {loading ? (
            ...
            <div className="space-y-6 mb-8">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-5 py-4 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 bg-white hover:border-blue-300 text-gray-900"
                >
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-5 py-4 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 hover:border-blue-300"
                />
              </div>
