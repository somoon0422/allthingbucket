      ...
      <div className="bg-white rounded-lg p-6 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            {existingReview && (
              <p className="text-xs text-primary-600 mt-1">기존 리뷰를 수정하여 재제출합니다</p>
            )}
          </div>
          <button
            onClick={onClose}
        ...
        <div className="space-y-6">
          ...
          <div className="flex space-x-3 pt-4">
            ...
            <button
              ...
              className="flex-2 px-6 py-2 bg-primary-600 text-white rounded-lg hover:bg-blue-700 disabled:bg-gray-400 disabled:cursor-not-allowed flex items-center justify-center"
            >
              {submitting ? (
                <>
